...
public class Calculator {
	...
	public static void initCalculator() {
		...
		unit = temperature.addUnit("celsius", "Cº", new BigDecimal("1"));
		unit.addAlternativeAbr("celsius");
		unit = temperature.addUnit("farenheit", "Fº", new BigDecimal("1").divide(new BigDecimal("1.8"), 100, RoundingMode.HALF_UP));
		...
		pi = Variable.makeConstant(new BigDecimal("3.14159265358979323846264338327950288419716939937510"), "π", Measure.unitlessBase, "pi", null);
		...
		unit = unitlesMeasure.addUnit("degrees", "º", PI.divide(new BigDecimal("180"), 100, RoundingMode.HALF_UP) );
		unit.addAlternativeAbr("deg");
		unit = unitlesMeasure.addUnit("pi", "π", PI);
		...
		unitlesMeasure.addUnit("per mil", "‰", new BigDecimal("0.001"));
