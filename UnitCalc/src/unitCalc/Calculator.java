...
public class Calculator {
	...
	public static void initCalculator() {
		...
		unit = unitless.addUnit("degrees", "º", Variable.varMap.get("pi").value.divide(new BigDecimal("180"), 100, RoundingMode.HALF_UP) );
		unit.addAlternativeAbr("deg");
		unit = unitless.addUnit("pi", "π", Variable.varMap.get("pi").value);
